...
static const struct spi_device_id st7735fb_device_id[] = {
	{
		...
		.name = "cfaf128128b0145t",
		.driver_data = ST7735_CFAF128128B_0145T,
	}, {
		/* sentinel */
	}
};
...
static const struct of_device_id st7735fb_dt_ids[] = {
	...
	{ .compatible = "crystalfontz,cfaf128128b0145t", .data = (void *) ST7735_CFAF128128B_0145T, },
};
...
static int st7735fb_init(void)
{
	return spi_register_driver(&st7735fb_driver);
}

static void st7735fb_exit(void)
{
